...
OpenCV2::Mat - Matrix operations

=end NAME

=begin SYNOPSIS

    my $m = OpenCV2::Mat.new( 2, 2 );
...
#      is native(LIB) { * }
	...
	#
	sub cvCloneMat( OpenCV2::Mat $mat )
		returns OpenCV2::Mat
		is native(LIB) { * }

	# Completes the symmetric matrix from the lower (LtoR=0)
	# or from the upper (LtoR!=0) part
	#
